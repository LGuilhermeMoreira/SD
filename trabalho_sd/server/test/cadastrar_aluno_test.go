...
func TestCadastrarAluno(t *testing.T) {
	...
	aluno := dto.Aluno{
		...
		Curso:       "CC",
		Cpf:         "12332145678",
		Disciplinas: []models.Disciplina{*models.NewDisciplina("SD", "SD001", *models.NewProfessor("marcos", "marcos@email.com"))},
	}
...
func TestCadastrarAlunoFail(t *testing.T) {
	cnfg := NewTestConnction()
